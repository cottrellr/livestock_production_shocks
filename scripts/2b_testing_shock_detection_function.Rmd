...
shock_detector <- function(target_time_series, target_cooks_distance, target_span){
  this_time_series <- target_time_series
  this_model <- loess(this_time_series~seq(1:length(this_time_series)))
...
shock_detector(target_time_series = some_test_data, target_cooks_distance = 0.3) #works nicely
