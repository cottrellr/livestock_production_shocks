...
saveRDS(shocks_by_cooks_distance, file = here("data", "generated_data", "shocks_w_baselines_cooks_distance.rds"))
...
shock_loess_apply <-   function(this_span){
  ...
  #element
  #this_element <- which(spans==this_span)
...
saveRDS(shocks_by_span, file = here("data", "generated_data", "shocks_w_baselines_span.rds"))
